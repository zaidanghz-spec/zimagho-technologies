...
function writeReadme(out) {
  writeFileSync(
    ...
    [
      ...
      "",
      "ISI FOLDER",
      "  index.html        \u2014 situs utama Adhikarsa (satu halaman, 12 bab)",
      "  en/               \u2014 profil perusahaan versi English",
      "  id/               \u2014 profil perusahaan versi Bahasa Indonesia",
      "",
      "  Tiap bahasa profil berisi halaman: Beranda, Perusahaan, Solusi,",
